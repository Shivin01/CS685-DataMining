...
if __name__ == "__main__":
    ...
    user_responses = session.query(UserResponse).all()
    ...
    user_responses_list = [model_to_dict(response) for response in user_responses]
    ...
    dp = df[df['user_id'] == 48]
    print(dp.shape)
    df.to_json('user_response_df_6-Nov.json')